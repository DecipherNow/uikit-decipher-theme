...
(function(addon) {
    ...
    if (typeof define == 'function' && define.amd) {
        define('github:DecipherNow/uikit-decipher-theme@master/js/uikit-timepicker', ['github:DecipherNow/uikit-decipher-theme@master/js/uikit'], function(){
    ...
    UI.component('timepicker', {
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on('focus.timepicker.github:DecipherNow/uikit-decipher-theme@master/js/uikit', '[data-uk-timepicker]', function(e) {
